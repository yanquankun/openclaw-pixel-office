...
import { vscode, onServerMessage } from '../wsClient.js'
  ...
  useEffect(() => {
    ...
    const handler = (e: MessageEvent) => {
      ...
      if (msg.type === 'layoutLoaded') {
        ...
        // If layout is already loaded, we must add agents immediately.
        // (Server may send layoutLoaded before existingAgents.)
    ...
    const unsubscribe = onServerMessage((data) => handler({ data } as MessageEvent))
